-- 테이블명에 solo_ 접두사 추가 마이그레이션 실행

-- 1. articles → solo_articles 변경
...
-- 4. function_logs → solo_function_logs 변경
...
-- 5. chat_messages → solo_chat_messages 변경 (존재하는 경우)
